...
//    NSMutableData *hash = [NSMutableData dataWithData:secret_];
    NSString *str = [[NSMutableString alloc] initWithData:hash encoding:NSUTF8StringEncoding];
    NSLog(@"%@", str);
    ...
    uint32_t truncatedHash = NSSwapBigIntToHost(*((uint32_t *)&ptr[offset])) & 0x7fffffff;
